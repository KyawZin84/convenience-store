...
const CategoriesForm = () => {
  ...
  const createData = async () => {
    const response = await postRequest("categories/add", formValues);
    if (response.data) {
  ...
  const fetchData = async () => {
    const response = await getRequest(`categories/view/${params.Id}`);
    if (response.data) {
  ...
  const updateData = async () => {
    const response = await putRequest(`categories/change/${params.Id}`, formValues);
    if (response.data) {
      navigate('/categories/list')
    }
    else {
